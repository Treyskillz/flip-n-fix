...
export const MODULE_QUIZZES: ModuleQuiz[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        correctIndex: 1,
        explanation: 'A Price Reduction Request should only be submitted when a licensed inspector discovers material defects that were not visible or disclosed before your offer. This is a standard, ethical practice protected by the inspection contingency in your purchase agreement. Using it for cosmetic issues or as a pretext to renegotiate damages your reputation.',
      },
      {
        id: 'q-3-5',
        ...
        correctIndex: 1,
        explanation: 'Itemizing repairs into individual line items (e.g., 25 items at $600 each) with written contractor estimates creates a much stronger, more credible case than a single lump sum. Each line item is documented and defensible. Never misrepresent property condition — that is fraud.',
      },
    ],
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        correctIndex: 1,
        explanation: 'Wholesale assignment fees typically range from $5,000 to $25,000 or more, depending on the deal size and spread between your contract price and the end buyer\'s price. Larger spreads on higher-value properties can command even higher fees.',
      },
    ],
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        correctIndex: 1,
        explanation: 'Most conventional lenders require a 6-12 month seasoning period before they will refinance based on the new appraised value. During this time, you hold the property (usually with a hard money loan) and collect rent. Some portfolio lenders or credit unions may have shorter or no seasoning requirements.',
      },
    ],
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        correctIndex: 1,
        explanation: 'Sellers agree to subject-to deals because they are typically in financial distress — behind on payments, facing foreclosure, going through divorce, or relocating urgently. A subject-to deal saves their credit by keeping the mortgage current and avoids foreclosure on their record.',
      },
    ],
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        correctIndex: 1,
        explanation: 'Rental arbitrage means signing a long-term lease (with the landlord\'s written permission to sublet) and then listing the property on Airbnb/VRBO at a higher nightly rate. The profit is the difference between your monthly lease payment and your short-term rental income. This requires no property ownership or down payment.',
      },
    ],
  },
  {
  ...
  {
    moduleId: 'mod-10',
    moduleTitle: 'Bonus: Asset Protection for Real Estate Investors',
    questions: [
      {
        id: 'q-10-1',
      ...
      },
      {
        ...
        correctIndex: 1,
        explanation: 'A land trust holds title to property with a trustee as the legal owner, while you (the beneficiary) control and benefit from the property. Your name does not appear in public records, providing privacy. This is especially useful for subject-to deals and protecting your identity as an investor.',
      },
    ],
  },
  {
    moduleId: 'mod-11',
    moduleTitle: 'Bonus: Creative Financing Mastery',
    questions: [
      {
        id: 'q-11-1',

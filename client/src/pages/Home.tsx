...
const WELCOME_VIDEO_URL = 'https://d2xsxph8kpxj0f.cloudfront.net/310419663030273730/c3pk6dbyVkhix88pdfEyoY/Freedom_One_Welcome_b62d165a.mp4';
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="container py-16">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold tracking-tight mb-3">See the Freedom One System in Action</h2>
          <p className="text-muted-foreground max-w-xl mx-auto">
            Watch a quick overview of how the Freedom One system of real estate investment helps you analyze deals, estimate rehabs, and maximize profit.
          </p>
        </div>
